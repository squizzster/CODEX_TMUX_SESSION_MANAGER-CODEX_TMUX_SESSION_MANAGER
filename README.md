...
that daemon as `rodex_daemon` rather than a generic Python process. Existing daemons
retain their loaded code, so stop their runtimes and daemon after installing a new Rodex
version.
