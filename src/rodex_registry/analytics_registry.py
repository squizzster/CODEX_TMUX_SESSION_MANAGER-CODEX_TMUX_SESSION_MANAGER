...
class RodexAnalyticsRegistry:
    ...
    def load_checkpoint(self) -> RodexSessionStatisticsView:
        """Load the last committed analytics checkpoint for this worker."""
        return read_rodex_session_statistics(self._session_id, self._database_path)
    ...
    def record_health_transition(
        ...
        *,
        ...
        consecutive_failures = (
            (0 if prior is None else prior.consecutive_failures) + 1 if failed else 0
        )
